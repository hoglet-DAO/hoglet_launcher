// v3: identical to v2. The bonding-curve math is unit-agnostic: all "supra" /
// "token" terms below are now simply "quote" / "token" parameter names kept
// as-is to minimize the diff against the audited v2 implementation.
